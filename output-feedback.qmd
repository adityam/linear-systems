...
C = \MATRIX{0 & 1}.
$$
Determine a Luenberger observer gain $L$ such that the eigenvalues of $A - LC$ are at $-2 \pm j$. 
:::
...
This gives $2n$ tunable gains $k_0, \dots, k_{n-1}$ and $\ell_0, \dots, \ell_{n-1}$ and the hope is that we can find these gain to arbitrarily choose the eigenvalues of the closed loop system. 
