...
We first compute the GM. From the plot we see that the phase plot intersects the $-180 ^∘$ line at $ω_{\rm pc} = 10$ rad/s. At $ω_{\rm pc} = 10$, we have $|G(j ω_{\rm pc})| = -40$ dB. Thus, ${\rm GM} = 40$ dB. 

We now compute the PM. From the plot, we can see that the gain plot intersects the 0dB line at $ω = 1$. Thus, $ω_{\rm gc} = 1$ rad/s. At $ω_{\rm gc} = 1$, we have $\angle G(j ω_{\rm gc}) = -135 ^∘$. Thus, $\text{PM} = 180 ^∘ - 135 ^∘ = 45 ^∘$.
:::
...
We first compute the GM. From the plot we see that the phase plot intersects the $-180 ^∘$ line at $ω_{\rm pc} = 10^3$ rad/s. At $ω_{\rm pc} = 10^3$, we have $|G(j ω_{\rm pc})| = -100$ dB. Thus, ${\rm GM} = 100$ dB. 
...
We now compute the PM. From the plot, we can see that the gain plot intersects the 0dB line at $ω = 10^2$. Thus, $ω_{\rm gc} = 10^2$ rad/s. At $ω_{\rm gc} = 10^2$, we have $\angle G(j ω_{\rm gc}) = -90 ^∘$. Thus, $\text{PM} = 180 ^∘ - 90 ^∘ = 90 ^∘$.
:::
