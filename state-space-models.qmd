...
#| output: false
using Revise
using QuizQuestions, LaTeXStrings
```
...
$$G(s) = \dfrac{s+5}{s^2 + 3s + 2}.$$


```{julia}
radioq([
  L"$A = \begin{bmatrix} 0 & 1 \\ -2 & -3 \end{bmatrix},\ B = \begin{bmatrix} 0 \\ 1 \end{bmatrix},\ C = \begin{bmatrix} 5 & 1 \end{bmatrix}$",
  L"$A = \begin{bmatrix} 0 & -2 \\ 1 & -3 \end{bmatrix},\ B = \begin{bmatrix} 0 \\ 1 \end{bmatrix},\ C = \begin{bmatrix} 5 & 1 \end{bmatrix}$",
  L"$A = \begin{bmatrix} 0 & 1 \\ -2 & -3 \end{bmatrix},\ B = \begin{bmatrix} 1 \\ 0 \end{bmatrix},\ C = \begin{bmatrix} 1 & 5 \end{bmatrix}$",
  L"$A = \begin{bmatrix} 0 & -2 \\ 1 & -3 \end{bmatrix},\ B = \begin{bmatrix} 1 \\ 0 \end{bmatrix},\ C = \begin{bmatrix} 1 & 5 \end{bmatrix}$",
], 1, label="Find the CCF representation of the system:")
```
:::

:::{#exm-CCF-2}
Consider a system with the transfer function
$$G(s) = \dfrac{5}{s^3 - s^2 - 4s + 4}.$$

```{julia}
radioq([
  L"$A = \begin{bmatrix} 0 & 1 & 0 \\ 0 & 0 & 1 \\ -4 & 4 & 1 \end{bmatrix},\ B = \begin{bmatrix} 0 \\ 0 \\ 1 \end{bmatrix},\ C = \begin{bmatrix} 5 & 0 & 0 \end{bmatrix}$",
  L"$A = \begin{bmatrix} 0 & 0 & -4 \\ 1 & 0 & 4 \\ 0 & 1 & 1 \end{bmatrix},\ B = \begin{bmatrix} 0 \\ 0 \\ 1 \end{bmatrix},\ C = \begin{bmatrix} 5 & 0 & 0 \end{bmatrix}$",
  L"$A = \begin{bmatrix} 0 & 1 & 0 \\ 0 & 0 & 1 \\ -4 & 4 & 1 \end{bmatrix},\ B = \begin{bmatrix} 1 \\ 0 \\ 0 \end{bmatrix},\ C = \begin{bmatrix} 0 & 0 & 5 \end{bmatrix}$",
  L"$A = \begin{bmatrix} 0 & 0 & -4 \\ 1 & 0 & 4 \\ 0 & 1 & 1 \end{bmatrix},\ B = \begin{bmatrix} 1 \\ 0 \\ 0 \end{bmatrix},\ C = \begin{bmatrix} 0 & 0 & 5 \end{bmatrix}$",
], 1, label="Find the CCF representation of the system:")
```
:::
...
```{julia}
radioq([
  L"$A = \begin{bmatrix} 0 & -2 \\ 1 & -3 \end{bmatrix},\ B = \begin{bmatrix} 5 \\ 1 \end{bmatrix},\ C = \begin{bmatrix} 0 & 1 \end{bmatrix}$",
  L"$A = \begin{bmatrix} 0 & 1 \\ -2 & -3 \end{bmatrix},\ B = \begin{bmatrix} 5 \\ 1 \end{bmatrix},\ C = \begin{bmatrix} 0 & 1 \end{bmatrix}$",
  L"$A = \begin{bmatrix} 0 & -2 \\ 1 & -3 \end{bmatrix},\ B = \begin{bmatrix} 1 \\ 5 \end{bmatrix},\ C = \begin{bmatrix} 1 & 0 \end{bmatrix}$",
  L"$A = \begin{bmatrix} 0 & 1 \\ -2 & -3 \end{bmatrix},\ B = \begin{bmatrix} 1 \\ 5 \end{bmatrix},\ C = \begin{bmatrix} 1 & 0 \end{bmatrix}$",
], 1, label="Find the OCF representation of the system:")
```
:::
...
```{julia}
radioq([
  L"$A = \begin{bmatrix} 0 & 0 & -4 \\ 1 & 0 & 4 \\ 0 & 1 & 1 \end{bmatrix},\ B = \begin{bmatrix} 5 \\ 0 \\ 0 \end{bmatrix},\ C = \begin{bmatrix} 0 & 0 & 1 \end{bmatrix}$",
  L"$A = \begin{bmatrix} 0 & 1 & 0 \\ 0 & 0 & 1 \\ -4 & 4 & 1 \end{bmatrix},\ B = \begin{bmatrix} 5 \\ 0 \\ 0 \end{bmatrix},\ C = \begin{bmatrix} 0 & 0 & 1 \end{bmatrix}$",
  L"$A = \begin{bmatrix} 0 & 0 & -4 \\ 1 & 0 & 4 \\ 0 & 1 & 1 \end{bmatrix},\ B = \begin{bmatrix} 0 \\ 0 \\ 1 \end{bmatrix},\ C = \begin{bmatrix} 5 & 0 & 0 \end{bmatrix}$",
  L"$A = \begin{bmatrix} 0 & 1 & 0 \\ 0 & 0 & 1 \\ -4 & 4 & 1 \end{bmatrix},\ B = \begin{bmatrix} 0 \\ 0 \\ 1 \end{bmatrix},\ C = \begin{bmatrix} 0 & 0 & 5 \end{bmatrix}$",
], 1, label="Find the OCF representation of the system:")
```
:::
...
```{julia}
radioq([
  L"$A = \begin{bmatrix} -1 & 0 \\ 0 & -2 \end{bmatrix},\ B = \begin{bmatrix} 1 \\ 1 \end{bmatrix},\ C = \begin{bmatrix} 4 & -3 \end{bmatrix}$",
  L"$A = \begin{bmatrix} 0 & 1 \\ -2 & -3 \end{bmatrix},\ B = \begin{bmatrix} 1 \\ 1 \end{bmatrix},\ C = \begin{bmatrix} 4 & -3 \end{bmatrix}$",
  L"$A = \begin{bmatrix} -1 & 0 \\ 0 & -2 \end{bmatrix},\ B = \begin{bmatrix} 0 \\ 1 \end{bmatrix},\ C = \begin{bmatrix} 5 & 1 \end{bmatrix}$",
  L"$A = \begin{bmatrix} 0 & 1 \\ -2 & -3 \end{bmatrix},\ B = \begin{bmatrix} 0 \\ 1 \end{bmatrix},\ C = \begin{bmatrix} 5 & 1 \end{bmatrix}$",
], 1, label="Find the DCF representation of the system:")
```
:::
...
```{julia}
radioq([
  L"$A = \begin{bmatrix} 2 & 0 & 0 \\ 0 & 1 & 0 \\ 0 & 0 & -2 \end{bmatrix},\ B = \begin{bmatrix} 1 \\ 1 \\ 1 \end{bmatrix},\ C = \begin{bmatrix} \tfrac{5}{4} & -\tfrac{5}{3} & \tfrac{5}{12} \end{bmatrix}$",
  L"$A = \begin{bmatrix} 0 & 1 & 0 \\ 0 & 0 & 1 \\ -4 & 4 & 1 \end{bmatrix},\ B = \begin{bmatrix} 1 \\ 1 \\ 1 \end{bmatrix},\ C = \begin{bmatrix} \tfrac{5}{4} & -\tfrac{5}{3} & \tfrac{5}{12} \end{bmatrix}$",
  L"$A = \begin{bmatrix} 2 & 0 & 0 \\ 0 & 1 & 0 \\ 0 & 0 & -2 \end{bmatrix},\ B = \begin{bmatrix} 0 \\ 0 \\ 1 \end{bmatrix},\ C = \begin{bmatrix} 5 & 0 & 0 \end{bmatrix}$",
  L"$A = \begin{bmatrix} 0 & 1 & 0 \\ 0 & 0 & 1 \\ -4 & 4 & 1 \end{bmatrix},\ B = \begin{bmatrix} 0 \\ 0 \\ 1 \end{bmatrix},\ C = \begin{bmatrix} 5 & 0 & 0 \end{bmatrix}$",
], 1, label="Find the DCF representation of the system:")
```
:::
...
:::{#exm-circuit-fall2025}
Find the state space model of the circuit shown in @fig-circuit-fall2025

![Question from Fall 2025](figures/svg/circuits11.svg){#fig-circuit-fall2025}
:::
...
:::{#exm-SS-to-TF-1}
Consider an LTI system with the following state space model:
$$A = \MATRIX{-1 & 2 \\ 3 & -1}, \quad B = \MATRIX{1 \\ 0}, \quad C = \MATRIX{2 & 1}.$$

```{julia}
radioq([
  L"$\dfrac{2s + 5}{s^2 + 2s - 5}$",
  L"$\dfrac{2s + 1}{s^2 + 2s - 5}$",
  L"$\dfrac{s + 5}{s^2 + 2s + 5}$",
  L"$\dfrac{2s + 5}{s^2 - 2s - 5}$",
], 1, label="Find the transfer function of the system:")
```
:::
...
Let $x = \MATRIX{2 \\ 3}$. Consider a new coordinate system defined by the basis vectors
$$v_1 = \MATRIX{1 \\ 0}
\quad\text{and}\quad
v_2 = \MATRIX{1 \\ 1}.
$$
```{julia}
radioq([
  L"$\tilde x = \begin{bmatrix} -1 \\ 3 \end{bmatrix}$",
  L"$\tilde x = \begin{bmatrix} 1 \\ 3 \end{bmatrix}$",
  L"$\tilde x = \begin{bmatrix} -1 \\ -3 \end{bmatrix}$",
  L"$\tilde x = \begin{bmatrix} 3 \\ -1 \end{bmatrix}$",
], 1, label=L"Find the representation of $x$ in the new coordinate system:")
```
:::
...
:::{#exm-eigenvalues}
Consider the matrix $A = \MATRIX{3 & 1 \\ 1 & 3 }$. Find the eigenvalues and eigenvectors of $A$.
:::
...
:::{#exr-canonical-forms}
Write the state-space representations of the following systems in the controllable canonical form, observable canonical form, and diagonal canonical form.

a. $G(s) = \dfrac{s+3}{(s+1)(s+2)}$

b. $G(s) = \dfrac{5}{s^3 - s^2 - 4s + 4}$
:::

:::{#exr-canonical-forms-higher-order}
Write the state-space representations of the following systems in the controllable canonical form and observable canonical form.

a. $G(s) = \dfrac{0.5s^2+ 2s + 1}{s^3 - 2 s^2 + 2.5}$

b. $G(s) = \dfrac{s^2 + 3s + 3}{s^3 + 5s^2 + 32 s + 8}$

c. $G(s) = \dfrac{s^3 + 3s^2 + 9s + 10}{s^4 + 9s^3 + 5s^2 + 32 s + 8}$
:::