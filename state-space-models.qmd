...
We want the RHS of the above equations to be expressed in terms of input $u(t)$ and state $(v_C(t), i_L(t))$. Note that $dv_C(t)/dt$ is already in terms of $i_L(t)$. We now use KVL to find an expression for $di_L(t)/dt$ in terms of the other variables:
\begin{align*}
