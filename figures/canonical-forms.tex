...
\startTEXpage[width=27cm]
  ...
  \NC C \EQ 
        ...
        \stopmatrix
        \qquad
        \rlap{\mathboxanchored{C-1}{\text[color=darkgray,style=\small]{Coeff are zero after a while}}}
    \NR
...
\startTEXpage[width=27cm]
  ...
  \startformula \startalign[m=2]
    ...
    \NC 
    \rlap{\hskip 1.4em \mathboxanchored{B-1}{\text[color=darkgray,style={\small}]{\framed[frame=off,align=middle]{Coeffs are zero \\ after a while}}}}
    \NR
    \NC 
        A \EQ 
       \startmatrix[fences=bracket,
