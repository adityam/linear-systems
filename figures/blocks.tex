...
\startMPpage[offset=1dk, stacking={\namedstackingparameter\empty{criterium}}] % {{{ Example 3 begingroup;
  ...
  draw boxes_pic sum_three shifted sum_three.c;
  draw boxes_pic G_one shifted G_one.c;
  draw boxes_pic G_two shifted G_two.c;
  draw boxes_pic G_three shifted G_three.c;
  ...
  for i = 1 upto 5 :
    ...
    drawarrow sum_one.e -- lft G_one.w;
    drawarrow G_one.e -- lft sum_two.w;
    drawarrow sum_two.e -- lft G_two.w;
    drawarrow G_two.e -- lft sum_three.w;
    drawarrow sum_three.e -- lft G_three.w;
    ...
    drawarrow H_one.w -+ bot sum_three.s;
  ...
  label.lrt("\tfx $-$",  sum_three.s + (2bp,0) ); 
