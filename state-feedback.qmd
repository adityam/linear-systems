...
$$\def\1{\vphantom{\dfrac{1}{C_1R_1}}}
  \MATRIX{ \1\dot v_1(t) \\ \1\dot v_2(t) } =
  \MATRIX{ -\left(\dfrac{1}{C_1R_1} + \dfrac{1}{C_1 R_3}\right) & \dfrac{1}{C_1R_3} \\
  \dfrac{1}{C_2R_3} & -\left(\dfrac{1}{C_2R_2} + \dfrac{1}{C_2R_3}\right)}
  \MATRIX{ \1v_1(t) \\ \1v_2(t) }
  + 
  \MATRIX{\dfrac{1}{C_1R_1} \\ \dfrac{1}{C_2R_2}} u(t).
$$
Consider the sum $\tilde v(t) = v_1(t) + v_2(t) = \MATRIX{I & I} \MATRIX{v_1(t) \\ v_2(t)}$, which satisfies
$$
\dot {\tilde v(t)} = 
  -\frac{1}{C_1R_1} v_1(t)
  - \frac{1}{C_2R_2} v_2(t)
 + \left[ \frac{1}{C_1R_1} - \frac {1}{C_2 R_2} \right] u(t).
$$
When the bridge is **balanced**, i.e., $R_1 C_1 = R_2 C_2 = RC$, we have
$$
\dot {\tilde v(t)} = -\frac{1}{RC} (v_1(t) + v_2(t)) = -\frac{1}{RC} \tilde v(t)
$$
