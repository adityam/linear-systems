...
course:
  ...
  tutorial-ta: "Yiwen Chen"
  lab-tas: "Yiping Liu and Shahin Mahdiyounrad"
  mid-term: "Oct 15"
  lectures:
    - "10:05am–11:25am Tuesday, Thursday (SADB 2/36)"
  tutorials:
    - "8:35am–10:25am Friday (MAASS 10)"
  labs:
...
Teaching Assistants
: - Tutorial TA: {{< meta course.tutorial-ta >}}
- Lab TAs: {{< meta course.lab-tas >}}
...
- H.K. Khalil, Control Systems: An Introduction, 1st Ed., Michigan Universtiy Press.
...
- **Laboratory (20%)** In-person weekly labs, to be conducted in groups of two. At the end of each lab, each group has to submit a lab report by filling in a Matlab Livescript template provided as part of the lab assignment. The lowest two lab grades will be dropped.
...
- Practice is the only way to learn the material. Each assignment has 4-5 questions to help understand the material. However, according to the current grading allocation, the TA has about 3-4 minutes to grade one assignment from a student. Clearly, that's not sufficient time to grade 4-5 questions. [**So, only 1 or 2 randomly selected questions in each assignment will be graded.**]{.text-danger}


- Attendance at labs is mandatory. You will receive marks for a lab only if you attend the corresponding lab session.
