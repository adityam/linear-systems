...
| 2    | [Pole Zero Plot Step response of first and second order systems, dominant pole approximation](step-response.qmd) <br /> _Reading_: Nise Ch. 4 |
| 3    | [State-space modeling, canoncial forms, transfer function of state space models](state-space-models.qmd) <br /> _Reading_: William and Lawrence Ch. 1 and Ch. 2 |
